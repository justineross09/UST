...
export default function Login() {
  ...
  const getData = async () => {
    await axios
      .get(`/api/requestForm/get-all-request-form`)
      .then((response) => {
  ...
  return (
    <Sublayout
      ...
      show={2}
    >
      <h1 className='my-4 text-3xl font-bold ml-6'>Statistic Report</h1>
      <div className='flex gap-4'>
        <Card
          value={data?.openNumber}
          label='Open'
        />
        <Card
          value={data?.resolveNumber}
          label='Resolved'
        />
        <Card
          value={data?.voidedNumber}
          label='Voided'
        />
        <Card
          value={data?.reopenedNumber}
          label='Reopened'
        />
      </div>
            ...
            datasets: [
              {
                ...
                data: [
                  ...
                  data?.resolveNumber,
                  data?.voidedNumber,
                  data?.reopenedNumber,'#F3592D'
                ],
                backgroundColor: ['#75B9E0', '#5DBD55', '#F3592D', '#FECB32'],
              },
            ],
          }}
